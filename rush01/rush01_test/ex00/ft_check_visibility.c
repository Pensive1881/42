...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/02 17:03:23 by mhamedin          #+#    #+#             */
/*   Updated: 2025/03/02 17:18:57 by mhamedin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_check_visibility(int **matrix, int *input_array)
{
	...
	ft_assign(up, input_array);
	ft_assign(down, input_array + 4);
	ft_assign(left, input_array + 8);
	ft_assign(right, input_array + 12);
